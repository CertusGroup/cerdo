...
cerDO is the Certus data ontology framework: developed for connecting data to real-world concepts.
...
cerDO can be used in a modular manner: experts and specialist can create their domain models to better understand their data requirements. However, a data management system should be in place prior to applying cerDO as consistent and rigorous data assets are critical for this framework's effectiveness.
